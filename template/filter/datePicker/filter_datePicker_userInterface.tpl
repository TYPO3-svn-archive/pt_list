...
jQuery(function(){ldelim}
	...
	// Create date picker
	// set date picker defaults
	jQuery.datepicker.setDefaults(jQuery.extend({ldelim}showMonthAfterYear: false{rdelim},
		# language is set via typocript: config.language, so make sure, your language fits to language in jqueryui
		jQuery.datepicker.regional['{if $language == "default"}en{else}{$language}{/if}'], pickerOpts)
	);
