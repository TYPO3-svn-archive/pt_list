...
$EM_CONF[$_EXTKEY] = array(
	...
	'constraints' => array(
		...
		'suggests' => array(
		  'static_info_tables (needed for demo-list application only )' => '',
		  'pt_jqueryui (needed for datepicker filter and timespan2 filter only)' => '',
          'pt_xml2pdf (needed to create PDF documents with pt_list only)' => '',
          'PEAR Spreadsheet_Excel_Writer (needed to create XLS documents with pt_list only - THIS IS JUST A HINT, please ignore if your server is correctly configured)' => '',
		),
	),
