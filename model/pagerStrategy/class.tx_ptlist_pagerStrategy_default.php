...
class tx_ptlist_pagerStrategy_default implements tx_ptlist_iPagerStrategy {
	...
	public function setConfiguration(array $conf) {
		...
		$this->conf['fix'] = isset($this->conf['fix']) ? $this->conf['fix'] : 0;      
		$this->conf['delta'] = isset($this->conf['delta']) ? $this->conf['delta'] : 0;
		$this->conf['delta'] = $this->conf['fix'] == 0 ? $this->conf['delta'] : 0;      
		$this->conf['pagesNoFirst'] = isset($this->conf['pagesNoFirst']) ? $this->conf['pagesNoFirst'] : 0;      
		$this->conf['pagesNoLast'] = isset($this->conf['pagesNoLast']) ? $this->conf['pagesNoLast'] : 0;      
