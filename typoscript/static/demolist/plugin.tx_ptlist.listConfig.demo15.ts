...
plugin.tx_ptlist.listConfig.demo15 {
	...
	columns {
		...
		70 {
			...
			renderUserFunctions	{
				...
				5 < plugin.tx_ptlist.alias.renderer_cObject
				5 {
					renderObj = TEXT
					renderObj.value = Edit
				}
				10 < plugin.tx_ptlist.alias.renderer_editIcon
				10 {
					dataDescriptionIdentifierContainingTheUid = countryuid
					table = static_countries
					fields =  name_en,cn_capital,cn_iso_2
				}
			}
		}
